...
public interface TileHandler {
	 ...
	 */
	List<MapLocation> getTilesInRange(MapLocation location, int range);
	 ...
	 */
	List<Unit> getUnitsInRange(MapLocation location, int range);
	 ...
	 */
	List<Unit> getUnitsInAttackRange(Unit unit);
	 ...
	 */
	List<MapLocation> getTilesInMoveRange(Unit unit);
